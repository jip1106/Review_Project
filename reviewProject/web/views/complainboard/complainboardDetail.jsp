...
<div class="container">
 <table id="commentTable" class="table table-condensed"></table>
                                ...
                                <span class="form-inline" role="form">
                                    <p>
                                        <div class="form-group">
                                            <input type="text" readonly="readonly" id="commentParentName" name="commentParentName" class="form-control col-lg-2" data-rule-required="true" placeholder="이름" maxlength="10" value="<%=member.getId() %>">
                                        </div>
                                        <div class="form-group">
                                            <!-- 다른거로 채우자 <input type="password" id="commentParentPassword" name="commentParentPassword" class="form-control col-lg-2" data-rule-required="true" placeholder="패스워드" maxlength="10">-->
                                        </div>
                                    </p>
                    ...
                    <table class="table table-condensed">
                    <form role="form" action="/review/reup" method="post">
                        <thead>
                            <tr>
                                <td>
