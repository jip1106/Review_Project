...
<div class="container">
   <div class="row">
      ...
      <div class="nav nav-pills col-md-8 text-right">
         <a href="#"> </font><font color="red">작성자 :  </font><font color="black"><%= Complainboard.getId() %></a> 
      </div>
   </div>
   <div class="container">
      <div class="row">
         <div class="col-sm-8 col-md-9">
            ...
            <div class="panel-footer">
               <div class="btn-group btn-group-justified">
                  ...
                  <a href="/review/cupdate?bnum=<%= Complainboard.getPostingNo() %>" class="btn" style="color: white; width: 30%">수정</a>
               		<div style="float: left; width: 5%"></div>
                  <a href="/review/cdelete?bnum=<%= Complainboard.getPostingNo() %>&location=<%=location %>&index=<%=index %>" class="btn" style="color: white; width: 30%">삭제</a>
                  	<div style="float: left; width: 5%"></div>
