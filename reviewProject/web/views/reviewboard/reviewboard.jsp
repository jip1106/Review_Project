...
<div align="left" style="margin-left: 10%; margin-right: 10%">
      <div align="left">    
         <form class="" role="form" action="/review/reviewSearchList" onsubmit = "return inputPleaseMessage();">
            <select name="location" class="btn" style="color: white">
            ...
            &nbsp;&nbsp;&nbsp;
            <select class="btn" name="category" style="color: white">
...
<!-- paging -->
   <%if(location.trim() == "" && category.trim() == "" && searchKeyWord.trim() == ""){%>
      ...
      <%}else if(category.trim() != "" && location.trim() == "" && searchKeyWord.trim() != ""){%>
         <div id="ui_pagination" align="center">
         <nav>
            <ul class="pagination">
               <!-- 이전페이지 처리 -->
