	...
	<div class="row">
		<div align="left" style="margin-left: 15%; margin-right: 15%">
			...
			<form role="form" name="reviewUpdate" action="/review/reviewUpdate" method="post" enctype="multipart/form-data"> 
				...
				<input type="hidden" name="no" value="<%=review.getPosting_no()%>">
				<input type="hidden" name="ofile" value="<%=review.getImageName()%>">
				<input type="hidden" name="rfile" value="<%=review.getRenameImageName()%>">
				<input type="hidden" name="page" value="<%=currentPage%>">
				<div class="form-group">
					<label for="title">Location</label> 
					<select class="selectpicker" name="location" required>
						<option value=""><%=review.getLocation()%></option>
				...
				<div class="form-group">
					...
					<select class="selectpicker" name="category" required>
						<option value=""><%=review.getCategory()%></option>
				...
				<label for="title">evaluation(<%=review.getEvaluation()%>점)</label>
				...
				<div class="form-group">
					...
					<input type="text" name="address" class="form-control" id="address" placeholder="address" value="<%=review.getAddress()%>" required> 
					<span class="help-block"></span>
				</div>
				
				<div class="form-group">
					<label for="title">StoreName</label> 
					<input type="text" name="storename" class="form-control" id="storename" placeholder="storename" value="<%=review.getStoreName()%>" required> 
					<span class="help-block"></span>
				</div>
				
				<div class="form-group">
					<label for="title">Title</label> 
					<input type="text" name="title" class="form-control" id="title" placeholder="title" value="<%=review.getTitle()%>" required> 
					<span class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="content">Content</label>
					<textarea cols="20" rows="20" name="content" class="form-control"  id="content" placeholder="content" required><%=review.getContent()%></textarea>
					 <span class="help-block"></span>  
				</div>
				...
				<div class="form-group">
					...
					<%=review.getImageName()%>(사진 그대로 사용 할 경우 빈칸으로 두고 수정해주세요!)
					<input type="file" name="image" class="form-control" id="image" placeholder="picture"> <span
