...
<body>
	...
	<div class="header">
		...
		<%if(member != null && member.getUserType()==1){%><!-- 회원 -->
			<li><a class="navbar-brand" style="color: black;"><%=member.getName()%>회원님 환영합니다.</a></li>
			<li><a class="navbar-brand" style="color: black;" href="/review/logout">Logout</a></li>
		<%}else if(member !=null && member.getUserType()==0){ %><!-- 관리자 -->
			<li><a class="navbar-brand" style="color: black;"><%=member.getName()%> 관리자님 환영합니다.</a></li>
			<li><a class="navbar-brand" style="color: black;" href="/review/logout">Logout</a></li>
		<%}else{%>	<!-- 비회원 -->
		...
		<%}%> 
			...
			<ul class="navi" style="align-self: center; width: 100%; height: 100%">
