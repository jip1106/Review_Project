...
/**
 * Servlet implementation class AdminReviewCommentListServlet
 */
@WebServlet("/adminReviewcomment.do")
public class AdminReviewCommentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminReviewCommentListServlet() {
        super();
