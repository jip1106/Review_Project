...
/**
 * Servlet implementation class AdminListShareCommentServlet
 */
@WebServlet("/adminSharecomment.do")
public class AdminListShareCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminListShareCommentServlet() {
        super();
